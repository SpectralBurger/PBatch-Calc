...
Simple chrome/firefox/edge extension to automate collection of Minimum Flight Time, static thrust (g) , T/W, Pitch Spd, Est Lvl Spd, Eff Drive, Power, Min Flight Time all in imperial units (except static thrust), from ecalc/Propcalc site
